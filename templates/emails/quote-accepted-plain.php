...
printf( esc_html__( 'Quoted price: %s', 'wc-artisan-tools' ), wp_strip_all_tags( wc_price( (float) ( $commission['quoted_price'] ?? 0 ) ) ) );
echo "\n\n";

echo esc_html__( 'View Commission:', 'wc-artisan-tools' ) . "\n";
